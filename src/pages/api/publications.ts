    ...
    const samplePublications = [
      {
        ...
        abstract: "Radio transients, such as pulsars and Fast Radio Bursts (FRBs), are primarily detected at centimetre radio wavelengths, where higher luminosities are found. However, observations of sources in dense environments are heavily affected by propagation effects which may hinder a detection. Millimetre wave observations bypass this complication but require the largest radio telescopes to compensate for the lower flux densities.",
      ...
      },
      {
        ...
        abstract: "Cross-telescope analysis reveals distinct morphological patterns in FRB populations, enabling improved characterization of progenitor systems.",
      ...
      },
      {
        ...
        abstract: "Novel clustering algorithms reveal previously unidentified morphological classes in FRB signals.",
      ...
      },
      {
        ...
        abstract: "We demonstrate successful domain adaptation techniques for transferring FRB detection models between different radio telescope systems.",
